...
import regionRouter from './app/region/region.routes.js';
import multiDayRouter from './app/MultiDayTours/multiDayTours.routes.js';
import oneiDayRouter from './app/OneDayTours/OneDayTours.routes.js';
import autorRouter from './app/AutorTours/AutorTours.routes.js';
import hot
elRouter from './app/Hotel/Hotel.routes.js';
import placesRouter from './app/Places/Places.routes.js';
import eventRouter from './app/Events/Events.routes.js';
...
app.use('/api/miltiDay', multiDayRouter);
app.use('/api/oneDay', oneDayRouter);
app.use('/api/region', regionRouter);
app.use('/api/region', regionRouter);
app.use('/api/region', regionRouter);
app.use('/api/region', regionRouter);
...
import regionRouter from './app/region/region.routes.js';
import multiDayRouter from './app/MultiDayTours/multiDayTours.routes.js';
import oneDayRouter from './app/OneDayTours/OneDayTours.routes.js';
import autorRouter from './app/AutorTours/AutorTours.routes.js';
import hotelRouter from './app/Hotel/Hotel.routes.js';
import placesRouter from './app/Places/Places.routes.js';
import eventRouter from './app/Events/Events.routes.js';
